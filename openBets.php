...
// check if is in session already - should be
...
// Query for open bets
$sql = "SELECT * FROM bets WHERE BetUsername = ? AND bet_status = 'Open' ORDER BY CreatedAt DESC";
...
<head>
    ...
    <link rel="stylesheet" href="open-bets-design.css">
...
<body>
    ...
    <main class="flex-container">
        <section class="welcome-section">
            <span class="titleName"><!--username-->'s Open Bets</span>
